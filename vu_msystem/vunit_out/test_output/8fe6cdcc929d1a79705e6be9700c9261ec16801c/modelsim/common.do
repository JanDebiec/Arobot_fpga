...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini e:/project/msystem/msystem/soft_fpga/vu/vunit_out/modelsim/modelsim.ini -wlf {e:/project/msystem/msystem/soft_fpga/vu/vunit_out/test_output/8fe6cdcc929d1a79705e6be9700c9261ec16801c/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/encoder_raw_auto_tb/runner_cfg={"active python runner : true,enabled_test_cases : None,output path : e::/project/msystem/msystem/soft_fpga/vu/vunit_out/test_output/8fe6cdcc929d1a79705e6be9700c9261ec16801c/"} lib.encoder_raw_auto_tb(behave)   -L vunit_lib -L lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini e:/project/msystem/msystem/soft_fpga/vu/vunit_out/modelsim/modelsim.ini -wlf {e:/project/msystem/msystem/soft_fpga/vu/vunit_out/test_output/8fe6cdcc929d1a79705e6be9700c9261ec16801c/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/encoder_raw_auto_tb/runner_cfg={"active python runner : true,enabled_test_cases : None,output path : e::/project/msystem/msystem/soft_fpga/vu/vunit_out/test_output/8fe6cdcc929d1a79705e6be9700c9261ec16801c/"} lib.encoder_raw_auto_tb(behave)   -L vunit_lib -L lib' failed
