...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini e:/project/msystem/msystem/soft_fpga/vu/vunit_out/modelsim/modelsim.ini -wlf {e:/project/msystem/msystem/soft_fpga/vu/vunit_out/tests/lib.buffer_control_single_tb.all/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/buffer_control_single_tb/runner_cfg={"enabled_test_cases : None,output path : e::/project/msystem/msystem/soft_fpga/vu/vunit_out/tests/lib.buffer_control_single_tb.all/,active python runner : true"} lib.buffer_control_single_tb(behave)   -L vunit_lib -L lib}
    }]
    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini e:/project/msystem/msystem/soft_fpga/vu/vunit_out/modelsim/modelsim.ini -wlf {e:/project/msystem/msystem/soft_fpga/vu/vunit_out/tests/lib.buffer_control_single_tb.all/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/buffer_control_single_tb/runner_cfg={"enabled_test_cases : None,output path : e::/project/msystem/msystem/soft_fpga/vu/vunit_out/tests/lib.buffer_control_single_tb.all/,active python runner : true"} lib.buffer_control_single_tb(behave)   -L vunit_lib -L lib' failed
