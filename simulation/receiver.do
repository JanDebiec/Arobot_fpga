...
vcom -93 -work work $localpath\\source\\receiver.vhd
...
vcom -93 -work work $localpath\\testbench\\bit_filter_TB.vhd
vcom -93 -work work $localpath\\testbench\\byte_reader_stim_fp_pkg.vhd
vcom -93 -work work $localpath\\testbench\\byte_reader_TB.vhd
vcom -93 -work work $localpath\\testbench\\receiver_TB.vhd

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiv -L rtl_work -L work -voptargs="+acc"  receiver_TB

add wave receiver_TB/U_DUT/*
